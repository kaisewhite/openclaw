...
2. Verify cross-account role assumption:
   - `aws sts assume-role --role-arn arn:aws:iam::896502667345:role/cross-account-developer --role-session-name qa-diag --region us-east-1 --no-cli-pager --cli-connect-timeout 3 --cli-read-timeout 10`
